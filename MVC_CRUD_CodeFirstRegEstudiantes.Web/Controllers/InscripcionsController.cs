...
using MVC_CRUD_CodeFirstRegEstudiantes.Model.DAL;
using MVC_CRUD_CodeFirstRegEstudiantes.Model.Models;

namespace MVC_CRUD_CodeFirstRegEstudiantes.Web.Controllers
{
    public class InscripcionsController : Controller
    {
        private EstudiantesContext db = new EstudiantesContext();

        // GET: Inscripcions
        public ActionResult Index()
        {
            var inscripcions = db.Inscripcions.Include(i => i.Curso).Include(i => i.Estudiante);
